...
const Registration = () => {
    ...
    const { user, createUser, updateUserProfile, googleProviderLogin, githubProviderLogin, verifyEmail } = useContext(AuthContext);
                    ...
                    <div>
                        ...
                        <div className="d-grid gap-2">
                            ...
                            <Button onClick={handleGithubSignIn} variant="secondary" size="lg">
                                <p className='m-0'><FaGithub></FaGithub><span> GitHub SignUp</span></p>
                            </Button>
                        </div>
                    </div>
                </Col>
